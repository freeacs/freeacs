...
public interface MessageAttributeInterface {
	public enum MessageAttributeType { MappedAddress, ResponseAddress, ChangeRequest, SourceAddress, ChangedAddress, Username, Password, MessageIntegrity, ErrorCode, UnknownAttribute, ReflectedFrom, ConnectionRequestBinding, BindingChange, Dummy };
	...
	final static int CONNECTIONREQUESTBINDING = 0xC001;
	final static int BINDINGCHANGE = 0xC002;
