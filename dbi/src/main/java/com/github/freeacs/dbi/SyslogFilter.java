 ...
 * 
 * ....field >= startField AND field < endField....
 * 
 * In other words, the start is inclusive, but the end is exclusive. If you
 * want to just search for, let's say severity-level 6, then use these
 * filters:
 * 
 * setSeverityStart(6)
 * setSeverityEnd(7)
 * 
 * All other filters/fields are straight forward.
 * @author Morten
 *
 */
