...
public class UnittypeParameter {
	...
	public UnittypeParameter(Unittype unittype, String name, UnittypeParameterFlag flag) {
		if (unittype == null)
			throw new IllegalArgumentException("The unittype cannot be null in UnittypeParameter() contstructor");
		this.unittype = unittype;
		if (name == null || name.trim().length() == 0 || flag == null)
			throw new IllegalArgumentException("The unittype parameter name and flag cannot be null or empty strings");
		this.name = name;
		this.flag = flag;
	}
	...
	public boolean equals(Object o) {
		if (o != null && o instanceof UnittypeParameter) {
			...
			if (oCasted.getId() != null && this.getId() != null)
	...
	public void setFlag(UnittypeParameterFlag flag) {
		if (flag.isReadOnly() && values != null)
			throw new IllegalArgumentException("Not allowed to change parameter to read-only because there are specified values for this parameter");
		this.flag = flag;
	}
	...
	public void setValues(UnittypeParameterValues values) {
		if (values != null && getFlag().isReadOnly())
			throw new IllegalArgumentException("Not allowed to set enumerated values for a read-only unit type parameter");
		this.values = values;
	}
