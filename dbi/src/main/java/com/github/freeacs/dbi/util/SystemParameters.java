...
public class SystemParameters {
  ...
  // script/vendor config file)
  //	public static final String TARGET_FILENAME = "System.X_FREEACS-COM.Download.TargetFileName";
  //	public static final String TARGET_TR069_SCRIPT_FILENAME =
  // "System.X_FREEACS-COM.TR069Script.DesiredTR069ScriptTargetFileName";
  ...
  // "System.X_FREEACS-COM.Staging.Provider.SerialNumberParameter";
  //	public static final String STAGING_PROVIDER_SECPARAMETER =
  // "System.X_FREEACS-COM.Staging.Provider.SecretParameter";
  ...
  public static Map<String, UnittypeParameterFlag> commonParameters =
      new TreeMap<String, UnittypeParameterFlag>();
  public static Map<String, UnittypeParameterFlag> stagingParameters =
      new TreeMap<String, UnittypeParameterFlag>();
  ...
  public static boolean isTR069ScriptVersionParameter(String parameterName) {
    return parameterName.contains(SystemParameters.DESIRED_TR069_SCRIPT)
