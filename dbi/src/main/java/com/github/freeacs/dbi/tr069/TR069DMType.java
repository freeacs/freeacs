...
public enum TR069DMType {
	...
	UNSIGNEDLONG(0, Long.MAX_VALUE, "xsd:unsignedLong"), // Real-max is 18446744073709551615
	STATSCOUNTER32(0, 4294967295l, "xsd:unsignedInt"), //
	STATSCOUNTER64(0, Long.MAX_VALUE, "xsd:unsignedLong"), // Real-max is 18446744073709551615
	...
	//	private TR069DMType(int min, int max, String xsdType) {
	//		this.min = min;
	//		this.max = max;
	//	}
