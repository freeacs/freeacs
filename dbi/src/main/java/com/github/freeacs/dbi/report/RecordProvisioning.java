...
public class RecordProvisioning extends Record<RecordProvisioning> {
	private static KeyFactory keyFactory = new KeyFactory("Unittype", "Profile", "SoftwareVersion", "Output");
	private Key key;
	...
	public RecordProvisioning(Date tms, PeriodType periodType, String unittypeName, String profileName, String softwareVersion, String output) {
		this.tms = tms;
		...
		this.output = output;
		this.key = keyFactory.makeKey(tms, periodType, unittypeName, profileName, softwareVersion, output);
	}
	...
	public RecordProvisioning clone() {
		RecordProvisioning clone = new RecordProvisioning(tms, periodType, unittypeName, profileName, softwareVersion, output);
	...
	public String toString() {
		return getKey().toString() + ": " + getProvisioningOkCount().get() + ", " + getProvisioningRescheduledCount().get() + ", " + ", " + getProvisioningErrorCount().get() + ", "
				+ getProvisioningMissingCount().get() + getSessionLengthAvg().get();
	}
