...
public class ProvisioningMessage {
	public enum ProvStatus {
		OK("OK"), DELAYED("DELAYED"), ERROR("ERROR");
	...
	public enum ProvOutput {
		EMPTY, CONFIG, SOFTWARE, SCRIPT, REBOOT, RESET, SHELL;
	}
	...
	public String syslogMsg(Syslog syslog) {
		return syslogMsg(syslog.getIdentity().getFacility(), syslog.getIdentity().getFacilityVersion(), syslog.getIdentity().getUser().getUsername());
	}
	...
	public String syslogMsg(int facility, String facilityVersion, String user) {
		...
		return SyslogClient.makeMessage(severity, new Date(), ipAddress, uniqueId, "ProvMsg: " + toString(), facility, facilityVersion, user);		
	}
	...
	public String toString() {
		...
		if (paramsRead != null)
			sb.append("PR:" + paramsRead + ", ");
		if (paramsWritten != null)
			sb.append("PW:" + paramsWritten + ", ");
		if (periodicInformInterval != null)
			sb.append("PI:" + periodicInformInterval + ", ");
		if (jobId != null)
			sb.append("JO:" + jobId + ", ");
		if (eventCodes != null)
			sb.append("EV:" + eventCodes + ", ");
		if (provMode != null)
			sb.append("PM:" + provMode + ", ");
		if (fileVersion != null)
			sb.append("FV:" + fileVersion + ", ");
		if (errorResponsibility != null)
			sb.append("ER:" + errorResponsibility + ", ");
		if (errorCode != null)
			sb.append("EC:" + errorCode + ", ");
		if (errorMessage != null)
			sb.append("EM:" + errorMessage);
