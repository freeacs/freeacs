...
public class SystemConstants {
	...
	public static String DEFAULT_SERVICEWINDOW_FREQUENCY_STR = "" + DEFAULT_SERVICEWINDOW_FREQUENCY_INT;
	public static String DEFAULT_SERVICEWINDOW_SPREAD_STR = "" + DEFAULT_SERVICEWINDOW_SPREAD_INT;
