...
public class RecordVoipCall extends Record<RecordVoipCall> {
	...
	private static KeyFactory keyFactory = new KeyFactory("Unittype", "Profile", "SoftwareVersion", "Channel");
	private Key key;
	...
	public RecordVoipCall(Date tms, PeriodType periodType, String unittypeName, String profileName, String softwareVersion, String channel) {
		this.tms = tms;
		...
		this.key = keyFactory.makeKey(tms, periodType, unittypeName, profileName, softwareVersion, channel);
	}
	...
	public RecordVoipCall clone() {
		RecordVoipCall clone = new RecordVoipCall(tms, periodType, unittypeName, profileName, softwareVersion, channel);
