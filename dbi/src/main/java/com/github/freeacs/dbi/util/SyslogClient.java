...
public class SyslogClient {
	...
	public static void notice(String unitId, String content, int facility, String facilityVersion, String user) {
	...
	public static void warn(String unitId, String content, int facility, String facilityVersion, String user) {
	...
	public static void error(String unitId, String content, int facility, String facilityVersion, String user) {
	...
	private static void send(int severity, String unitId, String content, Syslog syslog) {
		if (unitId == null) {
			logger.warn("SyslogClient.send() was not executed - unitId was not set - a message was not sent to the syslog server");
			return;
		}
	...
	private static void send(int severity, String unitId, String content, int facility, String facilityVersion, String user) {
		String msg = makeMessage(severity, new Date(), null, unitId, content, facility, facilityVersion, user);
		try {
			send(msg);
		} catch (Throwable t) {
	...
	public static String makeMessage(int severity, Date date, String ipAddress, String unitId, String content, Syslog syslog) {
		Identity id = syslog.getIdentity();
		return makeMessage(severity, date, ipAddress, unitId, content, id.getFacility(), id.getFacilityVersion(), id.getUser().getUsername());
	}

	public static String makeMessage(int severity, Date date, String ipAddress, String unitId, String content, int facility, String facilityVersion, String user) {
		String tmp = "";
		if (user != null)
			tmp += "USER:" + user + " ";
	...
	private static String makeMessage(int severity, Date date, String ipAddress, String unitId, String content, int facility) {
