...
public abstract class Record<R extends Record> {
	...
	static {
		...
		denomMap.put(RecordHardware.class.getName() + "memoryHeapDdrCurrentAvg".toLowerCase(), "KB free");
		...
		denomMap.put(RecordHardware.class.getName() + "memoryHeapOcmCurrentAvg".toLowerCase(), "KB free");
		...
		denomMap.put(RecordHardware.class.getName() + "memoryNpOcmCurrentAvg".toLowerCase(), "Pages free");
