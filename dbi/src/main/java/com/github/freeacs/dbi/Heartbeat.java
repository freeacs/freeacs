...
public class Heartbeat {
  ...
  public void setUnittype(Unittype unittype) {
    if (unittype == null) throw new IllegalArgumentException("Heartbeat unittype cannot be null");
  ...
  public void setName(String name) {
    if (name == null) throw new IllegalArgumentException("Heartbeat name cannot be null");
    this.name = name;
  }
  ...
  public void setTimeoutHours(Integer timeoutHours) {
    ...
    if (timeoutHours == null || timeoutHours < 1 || timeoutHours > 48) timeoutHours = 1;
