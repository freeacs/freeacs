...
public class Heartbeat {
	...
	public Heartbeat(Unittype unittype, String name, Group group, String expression, int timeoutHours) {
		setName(name);
	...
	public void setTimeoutHours(Integer timeoutHours) {
		if (validateInput && (timeoutHours < 1 || timeoutHours > 48))
			throw new IllegalArgumentException("The generate on absence timeout hours must be between 1 and 48 (hours)");
