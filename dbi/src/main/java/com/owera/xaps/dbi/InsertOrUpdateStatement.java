 ...
 * same columns involved. This class is a wrapper class around DynamicStatement,
 * which is more generic in it's approach to SQL generation.
 * @author Morten
 *
 */
public class InsertOrUpdateStatement {
	...
	public static class Field {
		...
		public boolean equals(Object o) {
			if (o instanceof Field) {
				Field f = (Field) o;
				if (f.getColumn().equals(this.getColumn()))
					return true;
			}
			return false;
		}
	...
	/**
	 * This method will either make an insert or and update. If primary
	 * keys are null, it will make an insert (the primary keys will
	 * be auto-generated), otherwise it will make
	 * an update. 
	 * @param c
	 * @return
	 * @throws SQLException 
	...
	public PreparedStatement makePreparedStatement(Connection c) throws SQLException {
		...
		for (Field field : fields) {
			if (field.isPrimaryKey()) {
				if (field.getValue() == null || field.getValue() instanceof NullString || field.getValue() instanceof NullInteger) {
					insert = true;
