 ...
 *       &lt;sequence>
 *         &lt;element name="item" type="{http://xml.ws.freeacs.github.com/}Unittype" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfUnittype {
     ...
     * 
     */
    public List<Unittype> getItem() {
        if (item == null) {
            item = new ArrayList<Unittype>();
        }
        return this.item;
    }
