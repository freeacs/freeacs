 ...
 *       &lt;sequence>
 *         &lt;element name="item" type="{http://xml.ws.freeacs.github.com/}Profile" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfProfile {
     ...
     * 
     */
    public List<Profile> getItem() {
        if (item == null) {
            item = new ArrayList<Profile>();
        }
        return this.item;
    }
