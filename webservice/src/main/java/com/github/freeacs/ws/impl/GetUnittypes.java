	...
	public GetUnittypesResponse getUnittypes(GetUnittypesRequest gur, DataSource xapsDs, DataSource syslogDs) throws RemoteException {
		try {
			...
			if (gur.getUnittypeName() != null) {
				...
				com.github.freeacs.ws.xml.Unittype[] unittypeArray = new com.github.freeacs.ws.xml.Unittype[1];
				...
				com.github.freeacs.ws.xml.Unittype[] unittypeArray = new com.github.freeacs.ws.xml.Unittype[unittypeXAPSArr.length];
				int i = 0;
