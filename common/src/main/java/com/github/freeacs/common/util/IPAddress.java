...
public class IPAddress {
   ...
   *
   * @param ipString An IPv4 address on standard dot-separated form, e.g. 192.168.1.1 or
   *     85.112.159.45.
   * @return Whether the IP address is public or not.
   */
  public static boolean isPublic(String addr) {
    if (addr.startsWith("192.168.") || addr.startsWith("10.")) return false;
    ...
    if (addr.startsWith("172.") && secondOctet >= 16 && secondOctet < 32) return false;
    return true;
  }
}
