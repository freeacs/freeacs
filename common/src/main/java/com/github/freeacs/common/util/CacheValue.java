 ...
 * <ul>
 * <li>Use Cache.SESSION (default) if you want it to timeout after X seconds
 * after last access to the object.
 * <li>Use Cache.ABSOLUTE if you want it to timeout after X seconds after
 * creation of the object.
 * <li>Use Cache.ABSOLUTE if you want it to timeout after at a certain time.
 * </ul>
 * The first constructor could handle all 3 ways, but the constructor with
 * Calendar is specifically made to fit the 3 option.
 * <p>
 * When reading you usually change the lastRead-timestamp. However, it is
 * possible to read "unnoticed", something that could be useful when you just
 * what to inspect the cache, not actually read as use the data for anything.
 * 
