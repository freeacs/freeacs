...
public class Schedule {
  ...
  /**
   * @param ms - for ScheduleType.INTERVAL: the number of milliseconds between each run - for other
   *     ScheduleTypes: the number of millisecond from start of that period
