...
public class HelpGroup {
  ...
  public Help getHelp(String command) {
    for (Help help : helpList) {
      if (command.equals(help.getCommand())) return help;
    }
    return null;
  }
  ...
  public String toHTML() {
    ...
    for (Help help : helpList) {
      ...
      sb.append(
          "<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Syntax:</b> "
              + encode(help.getSyntax().getSyntax())
              + "<p>\n");
      ...
      if (opts != null) {
        ...
        for (HelpOption opt : opts.getOptions()) {
          sb.append(
              "<li><b>" + encode(opt.getOption()) + "</b>: " + encode(opt.getComment()) + "\n");
        }
        sb.append("</ul>\n");
      }
      ...
      if (args != null) {
        ...
        for (HelpArgument arg : args.getArguments()) {
          sb.append(
              "<li><b>" + encode(arg.getArgument()) + "</b>: " + encode(arg.getComment()) + "\n");
        }
        sb.append("</ul>\n");
      }
