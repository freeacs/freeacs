...
public class Context {
  ...
  public void setUnittypeParameter(UnittypeParameter unittypeParameter) {
    ...
    if (unittypeParameter == null) this.commandCounterContext[5] = "";
    else this.commandCounterContext[5] = "U";
  }
  ...
  public void setGroup(Group group) {
    this.group = group;
    if (group == null) this.commandCounterContext[3] = "";
    else this.commandCounterContext[3] = "G";
  }
  ...
  public void setJob(Job job) {
    this.job = job;
    if (job == null) this.commandCounterContext[4] = "";
    else this.commandCounterContext[4] = "J";
  }
  ...
  public void setProfile(Profile profile) {
    ...
    if (profile == null) this.commandCounterContext[1] = "";
    else this.commandCounterContext[1] = "P";
  }
  ...
  public void setUnit(Unit unit) {
    this.unit = unit;
    if (unit == null) this.commandCounterContext[2] = "";
    else this.commandCounterContext[2] = "U";
  }
  ...
  public void setUnittype(Unittype unittype) {
    ...
    if (unittype == null) this.commandCounterContext[0] = "";
    else this.commandCounterContext[0] = "U";
  }
  ...
  public List<String> getCommands() {
    ...
    while (m.find(findPos)) {
      ...
      if (command.charAt(1) != '-' && command.charAt(0) != '<') commands.add(m.group(1));
      findPos = m.end();
    }
    return commands;
  }
  ...
  public String getHelp(String[] inputArr) {
    String input = null;
    if (inputArr != null && inputArr.length > 1) input = inputArr[1].toLowerCase();
  ...
  public String getPrompt() {
    String prompt = "/";
    if (unittype != null) prompt += "ut:" + unittype.getName() + "/";
    if (profile != null) prompt += "pr:" + profile.getName() + "/";
    if (unit != null) prompt += "un:" + unit.getId() + "/";
    if (group != null) prompt += "gr:" + group.getName() + "/";
    if (job != null) prompt += "jo:" + job.getName() + "/";
    if (unittypeParameter != null) prompt += "up:" + unittypeParameter.getName() + "/";
  ...
  public void resetXAPS(ACS acs) {
    ...
    if (this.getUnittype() != null) this.setUnittype(acs.getUnittype(this.getUnittype().getId()));
    if (this.getProfile() != null)
      this.setProfile(
          this.getProfile().getUnittype().getProfiles().getById(this.getProfile().getId()));
    if (this.getGroup() != null)
      this.setGroup(this.getUnittype().getGroups().getById(this.getGroup().getId()));
    if (this.getUnittypeParameter() != null)
      this.setUnittypeParameter(
          this.getUnittype().getUnittypeParameters().getById(this.getUnittypeParameter().getId()));
  }

  public boolean equals(Context context) {
    if (context.getUnittype() != this.getUnittype()) return false;
    if (context.getProfile() != this.getProfile()) return false;
    if (context.getUnit() != this.getUnit()) return false;
    if (context.getGroup() != this.getGroup()) return false;
