...
public class ParameterParser {
	 ...
	 * @throws FileUploadException the file upload exception
	 */
	public ParameterParser(HttpServletRequest req, ServletContext context) throws FileUploadException {
		this(req);
	...
	public String getRequestURLButExcludeSomeParameters(String... exclude) {
		...
		while (parms.hasMoreElements()) {
			...
			if (object.equals("index"))
				continue;
			if (excludedList.contains(object))
				continue;
	...
	public Integer getIntegerParameter(String name, Integer def) throws NumberFormatException {
		try {
			...
			if (toParse != null && toParse.equals("0"))
				return 0;
