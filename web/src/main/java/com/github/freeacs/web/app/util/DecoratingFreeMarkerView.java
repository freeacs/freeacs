...
public class DecoratingFreeMarkerView extends FreeMarkerView {
   ...
   *     <p>In the decorating template include the content template at your desired spot using
   *     <code>&lt;#include content_page /&gt;</code>
   ...
   *
   * <p>Will retrieve the decorating template
   *
