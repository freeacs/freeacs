...
public class SearchParameter {
	 ...
	 * @param isEnabled 
	 */
	public SearchParameter(String theParameterId, String theDisplayText, String theParameterValue,Operator operator,ParameterDataType type, Boolean isEnabled) {
