...
public class ScriptArg {
	...
	public enum ArgType {
		STRING, INTEGER, FILE, PROFILE, GROUP, JOB, UNIT, TRIGGER, SYSLOGEVENT, HEARTBEAT, ENUM;
	}
	...
	public ScriptArg(int index, String name, String type, String comment, String value, Unittype unittype, ScriptExecutionData inputData) throws Exception {
		this.index = index;
		this.name = name;
		...
		if (type != null) {
			...
			if (type.startsWith("profile")) {
				...
				profileDropDown = InputSelectionFactory.getDropDownSingleSelect(retrieveInput(inputData, index), null, Arrays.asList(unittype.getProfiles().getProfiles()));
			} else if (type.startsWith("file")) {
				this.type = ArgType.FILE;
				fileDropDown = InputSelectionFactory.getDropDownSingleSelect(retrieveInput(inputData, index), null, Arrays.asList(unittype.getFiles().getFiles()));
				...
				enumDropDown = InputSelectionFactory.getDropDownSingleSelect(retrieveInput(inputData, index), null, optionsWrapped);
