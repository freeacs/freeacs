 ...
 * 
 * Keeps information for one specific point in the history trail.
 * 
...
public class ContextItem {
	 ...
	 * 
	 * Makes sure that this current context item only stores relevant info, and also what selects should and should not display.
	 * 
	 * Also controls whether or not the "All" option in the selects is visible.
	 * 
	...
	/**
	 * Checks if the current page is a specific object, 
	 * for example if its a Unit Configuration page or a Profile Configuration page.
	 * A page that is NOT specific is the Group Overview page or Search page.
	 * 
	...
	public String getPageUrl(Page currentPage) {
		...
		case UNIT:
			return Page.UNIT.getUrl("unit=" + unitId + "&profile=" + profileName + "&unittype=" + unitTypeName);
		case UNITSTATUS:
			return Page.UNITSTATUS.getUrl("unit=" + unitId + "&profile=" + profileName + "&unittype=" + unitTypeName);
		case PROFILE:
