...
public class TableElementMaker {
	...
	public List<TableElement> getGroups(Unittype unittype, ACS ACS) throws Exception {
	...
	public List<TableElement> getTriggers(Unittype unittype, ACS ACS) throws Exception {
		List<TableElement> list = new ArrayList<TableElement>();
