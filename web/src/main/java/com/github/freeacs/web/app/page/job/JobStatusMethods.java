...
public class JobStatusMethods {
    ...
    private final GetStatusFromAcronymMethod statusFromAcronymConverter = new GetStatusFromAcronymMethod();
    private final ConvertStatusToAcronymMethod statusToAcronymConverter = new ConvertStatusToAcronymMethod();
