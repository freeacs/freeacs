...
/**
 * This wrapper class contains helper methods, and also a static converter method <code>convertRecords(Unit unit,Collection<RecordSyslog> records)</code> for a larger set of RecordSyslog objects.
 * 
...
public class RecordUIDataSyslogFromReport {
	 ...
	 * @return the list
	 */
	public static List<RecordUIDataSyslogFromReport> convertRecords(Unit unit,Collection<RecordSyslog> records){
