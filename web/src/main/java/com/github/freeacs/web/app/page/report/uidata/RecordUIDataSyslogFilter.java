...
public class RecordUIDataSyslogFilter {
	...
	private static final List<String> severityList = new ArrayList<String>(SyslogConstants.severityMap.values());

    public final String facility;
    public static final String facility_default = null;
	private static final List<String> facilityList = new ArrayList<String>(SyslogConstants.facilityMap.values());

    public final String eventid;
    public static final String eventid_default = null;
	private static final List<String> eventIdList = new ArrayList<String>(SyslogConstants.eventMap.values());
