...
public abstract class InputData {
	 ...
	 */
	public final Map<String, String> getErrors() throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
	 ...
	 * 
	 * Override it in the implementing class.
	 *
	 * @param root the root
	 */
	 ...
	 * @throws InvocationTargetException the invocation target exception
	 */
	public final boolean bindAndValidate(Map<String, Object> root) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
		bindForm(root);
		if (!validateForm()) {
