...
public class SessionCache {
  ...
  private static final SimpleDateFormat SYSLOG_RESULT_CACHE_KEY_FORMAT =
  ...
  private static String getRangeKey(String unit, String descriptor, Date from, Date to) {
    return key(
        unit,
        descriptor
            + SYSLOG_RESULT_CACHE_KEY_FORMAT.format(from)
            + SYSLOG_RESULT_CACHE_KEY_FORMAT.format(to));
  }

  private static String getSyslogRangeKey(
      String unit, String descriptor, Date from, Date to, String syslogFilter) {
    return key(
        unit,
        descriptor
            + SYSLOG_RESULT_CACHE_KEY_FORMAT.format(from)
   ...
   */
  @SuppressWarnings("unchecked")
  public static Report<RecordSyslog> getSyslogReport(
      String sessionId,
      String unitId,
      Date fromDate,
      Date toDate,
