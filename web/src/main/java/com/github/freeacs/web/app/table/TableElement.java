 ...
 * other parameters like unit or profile.
 * 
...
public class TableElement {
	...
	/**
	 * It should be impossible to "do a new" on this class outside the package.
	 * Especially without any constructor parameters.
	 */
	...
	public void addGroupParameter(GroupParameter groupParameter) {
		if (groupParameterList == null)
			groupParameterList = new ArrayList<GroupParameter>();
	...
	//		else
	//			throw new IllegalArgumentException("Parameter must be one of the following types: Unit,Profile,Group or Job");
	//	}
	...
	/**
	 * DEBUG PURPOSES ONLY. 
	 * HAS NOTHING DO WITH THE TABLE RENDERING.
	 * USED FOR EASILY DEBUGGING TABLE ELEMENTS WHILE STEPPING IN DEBUG MDOE.
	 */
	@Override
	public String toString() {
		return "[" + tab + getName() + " - " + (unitTypeParameter != null ? unitTypeParameter.getName() : "null") + "]";
	}
