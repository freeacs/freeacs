 ...
 * 
 * Each type of report will implement this differently.
 * 
...
public abstract class ReportRetriever{
	 ...
	 * @param xaps the xaps
	 */
	public ReportRetriever(ReportData inputData,ParameterParser params,XAPS xaps){
	 ...
	 */
	public abstract Report<?> generateReport(PeriodType periodType, Date start, Date end, List<Unittype> unittypes, List<Profile> profiles, Group groupSelect) throws Exception;
