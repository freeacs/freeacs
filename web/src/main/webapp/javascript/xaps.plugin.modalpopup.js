...
function returnRefresh(returnVal) {
    try{
        ...
        if(ModalUTP.ELEMENT_TO_UPDATE==null || ModalUTP.ELEMENT_TO_UPDATE["name"]==null){
            ...
            if(element==null){
                window.location.href="web?page=unittype";
                return;
            }
            ...
            var url = "web?page=getvalue&type="+ModalUTP.ELEMENT_TO_UPDATE["type"]+"&name="+name+unittype+profile+"&timestamp="+new Date().getMilliseconds();
