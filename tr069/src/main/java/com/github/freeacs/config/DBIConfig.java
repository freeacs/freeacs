...
public class DBIConfig {
    ...
    @Bean
    public DBI getDBI(DataSource dataSource, ACSCacheManager cacheManager) throws SQLException {
        ...
        return DBI.createAndInitialize(Integer.MAX_VALUE, dataSource, syslog, cacheManager);
    }
}
