...
public class HttpRequestProcessorTest {
  ...
  public void testNormalResponse() {
    ...
    String rebootResponse =
        "<soap:Body><cwmp:RebootResponse><Irreleevant /></cwmp:RebootResponse></soap:Body>";
  ...
  public void testPrettyMuchIrregularRequest() {
    // Given:
    String rebootResponse =
        "<soap:Body ddsd=ssdsdsddd ><cwmp:RebootResponse><Irreleevant /></cwmp:RebootResponse></soap:Body>";
