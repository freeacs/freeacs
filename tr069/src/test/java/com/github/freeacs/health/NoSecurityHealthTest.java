...
@ContextConfiguration(initializers = NoSecurityHealthTest.DataSourceInitializer.class)
public class NoSecurityHealthTest implements AbstractMySqlIntegrationTest {
